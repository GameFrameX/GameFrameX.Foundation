...
/// </summary>
/// <remarks>
/// Host name hash-based worker ID provider.
/// Derives a stable 0-31 worker ID from the machine's hostname.
/// </remarks>
public class HostNameWorkerIdProvider : IWorkerIdProvider
{
    /// <inheritdoc />
