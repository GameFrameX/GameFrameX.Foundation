...
/// </summary>
/// <remarks>
/// Provides big-endian read/write extension methods for byte arrays.
/// </remarks>
public static partial class ByteExtensions
{
    ...
    /// </summary>
    /// <remarks>
    /// Writes a 32-bit signed integer to the specified buffer in big-endian byte order and updates the offset.
    /// </remarks>
    /// <param name="buffer">要写入的缓冲区 / The buffer to write to.</param>
    /// <param name="value">要写入的值 / The value to write.</param>
    /// <param name="offset">要写入值的缓冲区中的偏移量 / The offset in the buffer to write the value.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Writes a 64-bit signed integer to the specified buffer in big-endian byte order and updates the offset.
    /// </remarks>
    /// <param name="buffer">要写入的缓冲区 / The buffer to write to.</param>
    /// <param name="value">要写入的值 / The value to write.</param>
    /// <param name="offset">要写入值的缓冲区中的偏移量 / The offset in the buffer to write the value.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Writes a single-precision floating-point number to the specified buffer in big-endian byte order and updates the offset.
    /// </remarks>
    /// <param name="buffer">要写入的缓冲区 / The buffer to write to.</param>
    /// <param name="value">要写入的值 / The value to write.</param>
    /// <param name="offset">要写入值的缓冲区中的偏移量 / The offset in the buffer to write the value.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Writes a double-precision floating-point number to the specified buffer in big-endian byte order and updates the offset.
    /// </remarks>
    /// <param name="buffer">要写入的缓冲区 / The buffer to write to.</param>
    /// <param name="value">要写入的值 / The value to write.</param>
    /// <param name="offset">要写入值的缓冲区中的偏移量 / The offset in the buffer to write the value.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Writes a byte array (with length prefix) to the specified buffer in big-endian byte order and updates the offset.
    /// </remarks>
    /// <param name="buffer">要写入的缓冲区 / The buffer to write to.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Writes a string to the specified buffer in big-endian byte order and updates the offset.
    /// </remarks>
    /// <param name="buffer">要写入的缓冲区 / The buffer to write to.</param>
    /// <param name="value">要写入的值 / The value to write.</param>
    /// <param name="offset">要写入值的缓冲区中的偏移量 / The offset in the buffer to write the value.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a 16-bit signed integer from the byte array in big-endian byte order and advances the offset.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a 16-bit unsigned integer from the byte array in big-endian byte order and advances the offset.
    /// </remarks>
    /// <param name="buffer">要读取的字节数组 / The byte array to read from.</param>
    /// <param name="offset">引用偏移量 / The reference offset.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a 32-bit signed integer from the byte array in big-endian byte order and advances the offset.
    /// </remarks>
    /// <param name="buffer">要读取的字节数组 / The byte array to read from.</param>
    /// <param name="offset">引用偏移量 / The reference offset.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a 32-bit unsigned integer from the byte array in big-endian byte order and advances the offset.
    /// </remarks>
    /// <param name="buffer">要读取的字节数组 / The byte array to read from.</param>
    /// <param name="offset">引用偏移量 / The reference offset.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a 64-bit signed integer from the byte array in big-endian byte order and advances the offset.
    /// </remarks>
    /// <param name="buffer">要读取的字节数组 / The byte array to read from.</param>
    /// <param name="offset">引用偏移量 / The reference offset.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a 64-bit unsigned integer from the byte array in big-endian byte order and advances the offset.
    /// </remarks>
    /// <param name="buffer">要读取的字节数组 / The byte array to read from.</param>
    /// <param name="offset">引用偏移量 / The reference offset.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a single-precision floating-point number from the given byte buffer in big-endian byte order and updates the offset.
    /// </remarks>
    ...
    /// <returns>从字节缓冲区中读取的单精度浮点数 / The single-precision floating-point number read from the byte buffer.</returns>
    /// <exception cref="ArgumentNullException">当 <paramref name="buffer"/> 为 null 时抛出 / Thrown when <paramref name="buffer"/> is null.</exception>
    /// <exception cref="ArgumentOutOfRangeException">当 <paramref name="offset"/> 为负数或读取位置超出缓冲区边界时抛出 / Thrown when <paramref name="offset"/> is negative or read position exceeds buffer bounds.</exception>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a double-precision floating-point number from the specified offset in big-endian byte order.
    /// </remarks>
    ...
    /// <returns>返回从缓冲区读取的双精度浮点数 / Returns the double-precision floating-point number read from the buffer.</returns>
    /// <exception cref="ArgumentNullException">当 <paramref name="buffer"/> 为 null 时抛出 / Thrown when <paramref name="buffer"/> is null.</exception>
    /// <exception cref="ArgumentOutOfRangeException">当 <paramref name="offset"/> 为负数或读取位置超出缓冲区边界时抛出 / Thrown when <paramref name="offset"/> is negative or read position exceeds buffer bounds.</exception>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a byte array of the specified length from the specified offset.
    /// </remarks>
    /// <param name="buffer">要操作的字节缓冲区 / The byte buffer to operate on.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a byte array of the specified length from the specified offset and updates the offset.
    /// </remarks>
    /// <param name="buffer">要操作的字节缓冲区 / The byte buffer to operate on.</param>
    /// <param name="offset">操作的起始偏移量 / The starting offset for the operation.</param>
    /// <param name="len">需要读取的字节数组长度 / The length of the byte array to read.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a byte array from the specified offset, with the length stored as an int at the beginning of the byte array (big-endian byte order).
    /// </remarks>
    /// <param name="buffer">要操作的字节缓冲区 / The byte buffer to operate on.</param>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a string from the byte array at the specified offset (big-endian byte order).
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Reads a string of the specified length from the byte array at the specified offset (big-endian byte order).
    /// </remarks>
    /// <param name="buffer">要从中读取数据的字节数组 / The byte array to read data from.</param>
    /// <param name="offset">读取数据的起始偏移量，此偏移量在读取后会自动增加 / The starting offset for reading, automatically increments after reading.</param>
