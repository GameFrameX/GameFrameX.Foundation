...
- 修复 OrmEntityTests 缺失断言的 Sonar S2699 违规 (#89)
...
- 更新 README 补齐密码哈希 KDF 文档

### Features

- 新增租户/数据权限/敏感字段/树形/导入导出特性
- 新增下一代密码哈希 KDF
...
- 添加多语言 README 支持 (zh-CN, zh-TW, ja, ko)
- 完善多语言翻译内容
...
- 迁移到 NuGet Trusted Publishing (OIDC)
- 添加 production 环境以匹配 NuGet Trusted Publishing 策略
...
- 添加支持四到八个属性值的调试消息记录方法
- 添加支持四到八个属性值的日志记录方法
- 添加支持四到八个属性值的警告消息记录方法
- 添加支持四到八个属性值的错误消息记录方法
- 添加支持四到八个属性值的错误消息记录方法
- 添加支持四到八个属性值的致命错误消息记录方法
- 添加支持四到八个属性值的警告消息记录方法
- 添加支持四到八个属性值的详细级别消息记录方法
