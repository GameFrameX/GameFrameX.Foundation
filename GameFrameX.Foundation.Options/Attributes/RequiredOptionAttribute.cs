...
{
    /// <summary>
    /// 初始化 <see cref="RequiredOptionAttribute"/> 类的新实例
    /// </summary>
    ...
    /// <summary>
    /// 使用指定的长名称初始化 <see cref="RequiredOptionAttribute"/> 类的新实例
    /// </summary>
    /// <param name="longName">选项的长名称</param>
    public RequiredOptionAttribute(string longName) : base(longName)
    {
        Required = true;
    }

    /// <summary>
    /// 使用指定的短名称和长名称初始化 <see cref="RequiredOptionAttribute"/> 类的新实例
    /// </summary>
