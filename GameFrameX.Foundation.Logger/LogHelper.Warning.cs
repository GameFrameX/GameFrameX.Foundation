...
public static partial class LogHelper
{
    ...
    /// 记录警告消息。
    /// </summary>
    /// <param name="message">要记录的警告消息 / The warning message to record</param>
    /// <remarks>
    /// Uses the default logger to record warning level log information.
    /// </remarks>
    ...
    /// <remarks>
    /// Used to record warning level log information.
    /// </remarks>
    ...
    /// <remarks>
    /// Uses structured logging to record warning level messages with a single property.
    /// </remarks>
    ...
    /// <remarks>
    /// Uses structured logging to record warning level messages with two properties.
    /// </remarks>
    ...
    /// <remarks>
    /// Uses structured logging to record warning level messages with three properties.
    /// </remarks>
    ...
    /// <param name="messageTemplate">消息模板 / The message template</param>
    /// <remarks>
    /// Records warning level exception information and message template.
    /// </remarks>
    ...
    /// <param name="propertyValue">属性值 / The property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with a single property.
    /// </remarks>
    ...
    /// <param name="propertyValue1">第二个属性值 / The second property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with two properties.
    /// </remarks>
    ...
    /// <param name="propertyValue2">第三个属性值 / The third property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with three properties.
    /// </remarks>
    ...
    /// <param name="propertyValue3">第四个属性值 / The fourth property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with four properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3>(Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3)
    {
        GetLogger().Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3);
    }
    ...
    /// <param name="propertyValue4">第五个属性值 / The fifth property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with five properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4>(Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4)
    {
        GetLogger().Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4);
    }
    ...
    /// <param name="propertyValue5">第六个属性值 / The sixth property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with six properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5>(Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5)
    {
        GetLogger().Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5);
    }
    ...
    /// <param name="propertyValue6">第七个属性值 / The seventh property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with seven properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5, T6>(Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5, T6 propertyValue6)
    {
        GetLogger().Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5, propertyValue6);
    }
    ...
    /// <param name="propertyValue7">第八个属性值 / The eighth property value</param>
    /// <remarks>
    /// Records warning level exception information and message template with eight properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5, T6, T7>(Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5, T6 propertyValue6, T7 propertyValue7)
    {
        GetLogger().Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5, propertyValue6, propertyValue7);
    }
    ...
    /// <remarks>
    /// Records warning level exception information and message template with multiple properties.
    /// </remarks>
    ...
    /// Uses structured logging to record warning level messages with four properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3>(ILogger logger, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3)
    {
        ArgumentNullException.ThrowIfNull(logger);
    ...
    /// Uses structured logging to record warning level messages with five properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4>(ILogger logger, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4)
    {
        ArgumentNullException.ThrowIfNull(logger);
    ...
    /// Uses structured logging to record warning level messages with six properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5>(ILogger logger, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5);
    }

    /// <summary>
    /// 使用指定的日志记录器记录带有七个属性值的警告消息模板。
    /// </summary>
    /// <typeparam name="T0">第一个属性值的类型 / The type of the first property value</typeparam>
    /// <typeparam name="T1">第二个属性值的类型 / The type of the second property value</typeparam>
    /// <typeparam name="T2">第三个属性值的类型 / The type of the third property value</typeparam>
    ...
    /// Uses structured logging to record warning level messages with seven properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5, T6>(ILogger logger, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5, T6 propertyValue6)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5, propertyValue6);
    }

    /// <summary>
    /// 使用指定的日志记录器记录带有八个属性值的警告消息模板。
    /// </summary>
    /// <typeparam name="T0">第一个属性值的类型 / The type of the first property value</typeparam>
    /// <typeparam name="T1">第二个属性值的类型 / The type of the second property value</typeparam>
    /// <typeparam name="T2">第三个属性值的类型 / The type of the third property value</typeparam>
    ...
    /// Uses structured logging to record warning level messages with eight properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5, T6, T7>(ILogger logger, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5, T6 propertyValue6, T7 propertyValue7)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5, propertyValue6, propertyValue7);
    }
    ...
    /// Records warning level exception information and message template with four properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3>(ILogger logger, Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3);
    }

    /// <summary>
    /// 使用指定的日志记录器记录带有异常和五个属性值的警告消息模板。
    /// </summary>
    /// <typeparam name="T0">第一个属性值的类型 / The type of the first property value</typeparam>
    /// <typeparam name="T1">第二个属性值的类型 / The type of the second property value</typeparam>
    /// <typeparam name="T2">第三个属性值的类型 / The type of the third property value</typeparam>
    ...
    /// Records warning level exception information and message template with five properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4>(ILogger logger, Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4);
    }

    /// <summary>
    /// 使用指定的日志记录器记录带有异常和六个属性值的警告消息模板。
    /// </summary>
    /// <typeparam name="T0">第一个属性值的类型 / The type of the first property value</typeparam>
    /// <typeparam name="T1">第二个属性值的类型 / The type of the second property value</typeparam>
    /// <typeparam name="T2">第三个属性值的类型 / The type of the third property value</typeparam>
    ...
    /// Records warning level exception information and message template with six properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5>(ILogger logger, Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5);
    }

    /// <summary>
    /// 使用指定的日志记录器记录带有异常和七个属性值的警告消息模板。
    /// </summary>
    /// <typeparam name="T0">第一个属性值的类型 / The type of the first property value</typeparam>
    /// <typeparam name="T1">第二个属性值的类型 / The type of the second property value</typeparam>
    /// <typeparam name="T2">第三个属性值的类型 / The type of the third property value</typeparam>
    ...
    /// Records warning level exception information and message template with seven properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5, T6>(ILogger logger, Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5, T6 propertyValue6)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5, propertyValue6);
    }

    /// <summary>
    /// 使用指定的日志记录器记录带有异常和八个属性值的警告消息模板。
    /// </summary>
    /// <typeparam name="T0">第一个属性值的类型 / The type of the first property value</typeparam>
    /// <typeparam name="T1">第二个属性值的类型 / The type of the second property value</typeparam>
    /// <typeparam name="T2">第三个属性值的类型 / The type of the third property value</typeparam>
    ...
    /// Records warning level exception information and message template with eight properties.
    /// </remarks>
    public static void Warning<T0, T1, T2, T3, T4, T5, T6, T7>(ILogger logger, Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2, T3 propertyValue3, T4 propertyValue4, T5 propertyValue5, T6 propertyValue6, T7 propertyValue7)
    {
        ArgumentNullException.ThrowIfNull(logger);
        logger.Warning(exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2, propertyValue3, propertyValue4, propertyValue5, propertyValue6, propertyValue7);
    }
    ...
    /// <param name="args">消息的格式参数 / Format arguments for the message</param>
    /// <remarks>
    /// Outputs warning information to both log file and console.
    /// Console output uses yellow font to highlight warning information.
    /// </remarks>
    ...
    /// <param name="args">消息的格式参数 / Format arguments for the message</param>
    /// <remarks>
    /// Records warning level log message with a tag prefix in the format [tag].
    /// </remarks>
    ...
    /// <exception cref="ArgumentNullException">当 <paramref name="logger"/> 为 null 时抛出 / Thrown when <paramref name="logger"/> is null</exception>
    /// <remarks>
    /// Records warning level log message with a tag prefix using the specified logger.
    /// </remarks>
    ...
    /// <param name="args">消息的格式参数 / Format arguments for the message</param>
    /// <remarks>
    /// Outputs warning information with tag to both log file and console using yellow font.
    /// </remarks>
