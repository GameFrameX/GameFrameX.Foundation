...
public static class HttpClientPatchExtension
{
    ...
    /// <summary>
    /// 发送PATCH请求，使用自定义序列化选项将JSON数据序列化后发送，并将响应内容读取为字符串。
    /// </summary>
    /// <remarks>
    /// Sends a PATCH request with JSON serialized data using custom serialization options and reads the response content as a string.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// <exception cref="ArgumentException">当 <paramref name="url"/> 为空字符串或空白字符串时抛出 / Thrown when <paramref name="url"/> is empty or whitespace</exception>
    /// <exception cref="HttpRequestException">当HTTP响应状态码表示失败时抛出 / Thrown when the HTTP response status code indicates failure</exception>
    public static async Task<string> PatchJsonToStringAsync<TValue>(this HttpClient httpClient, string url, TValue data, JsonSerializerOptions jsonSerializerOptions, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(httpClient, nameof(httpClient));
        ArgumentException.ThrowIfNullOrWhiteSpace(url, nameof(url));
        using var request = CreatePatchRequest(url, data, jsonSerializerOptions);
        using var response = await httpClient.SendAsync(request, cancellationToken);
        response.EnsureSuccessStatusCode();
        return await response.Content.ReadAsStringAsync(cancellationToken);
    }
    ...
    /// <summary>
    /// 发送PATCH请求，使用自定义请求头和序列化选项将JSON数据序列化后发送，并将响应内容读取为字符串。
    /// </summary>
    /// <remarks>
    /// Sends a PATCH request with JSON serialized data, custom headers and serialization options, then reads the response content as a string.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// <exception cref="ArgumentException">当 <paramref name="url"/> 为空字符串或空白字符串时抛出 / Thrown when <paramref name="url"/> is empty or whitespace</exception>
    /// <exception cref="HttpRequestException">当HTTP响应状态码表示失败时抛出 / Thrown when the HTTP response status code indicates failure</exception>
    public static async Task<string> PatchJsonToStringAsync<TValue>(this HttpClient httpClient, string url, TValue data, IDictionary<string, string> headers, JsonSerializerOptions jsonSerializerOptions, int timeout = 10, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(httpClient, nameof(httpClient));
        ArgumentException.ThrowIfNullOrWhiteSpace(url, nameof(url));
        ...
        using var request = CreatePatchRequest(url, data, headers, jsonSerializerOptions);
        using var response = await httpClient.SendAsync(request, cts.Token);
        response.EnsureSuccessStatusCode();
        return await response.Content.ReadAsStringAsync(cts.Token);
    }
    ...
    /// <summary>
    /// 发送PATCH请求，使用自定义序列化选项将JSON数据序列化后发送，并将响应内容读取为字节数组。
    /// </summary>
    /// <remarks>
    /// Sends a PATCH request with JSON serialized data using custom serialization options and reads the response content as a byte array.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// <exception cref="ArgumentException">当 <paramref name="url"/> 为空字符串或空白字符串时抛出 / Thrown when <paramref name="url"/> is empty or whitespace</exception>
    /// <exception cref="HttpRequestException">当HTTP响应状态码表示失败时抛出 / Thrown when the HTTP response status code indicates failure</exception>
    public static async Task<byte[]> PatchJsonToByteArrayAsync<TValue>(this HttpClient httpClient, string url, TValue data, JsonSerializerOptions jsonSerializerOptions, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(httpClient, nameof(httpClient));
        ArgumentException.ThrowIfNullOrWhiteSpace(url, nameof(url));
        using var request = CreatePatchRequest(url, data, jsonSerializerOptions);
    ...
    /// <summary>
    /// 发送PATCH请求，使用自定义请求头和序列化选项将JSON数据序列化后发送，并将响应内容读取为字节数组。
    /// </summary>
    /// <remarks>
    /// Sends a PATCH request with JSON serialized data, custom headers and serialization options, then reads the response content as a byte array.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// <exception cref="ArgumentException">当 <paramref name="url"/> 为空字符串或空白字符串时抛出 / Thrown when <paramref name="url"/> is empty or whitespace</exception>
    /// <exception cref="HttpRequestException">当HTTP响应状态码表示失败时抛出 / Thrown when the HTTP response status code indicates failure</exception>
    public static async Task<byte[]> PatchJsonToByteArrayAsync<TValue>(this HttpClient httpClient, string url, TValue data, IDictionary<string, string> headers, JsonSerializerOptions jsonSerializerOptions, int timeout = 10, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(httpClient, nameof(httpClient));
        ArgumentException.ThrowIfNullOrWhiteSpace(url, nameof(url));
    ...
    /// <summary>
    /// 发送PATCH请求，使用自定义序列化选项将JSON数据序列化后发送，并将响应内容读取为流。
    /// </summary>
    /// <remarks>
    /// Sends a PATCH request with JSON serialized data using custom serialization options and reads the response content as a stream.
    /// Note: The caller is responsible for disposing the returned stream.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    ...
    /// <exception cref="ArgumentException">当 <paramref name="url"/> 为空字符串或空白字符串时抛出 / Thrown when <paramref name="url"/> is empty or whitespace</exception>
    /// <exception cref="HttpRequestException">当HTTP响应状态码表示失败时抛出 / Thrown when the HTTP response status code indicates failure</exception>
    public static async Task<Stream> PatchJsonToStreamAsync<TValue>(this HttpClient httpClient, string url, TValue data, JsonSerializerOptions jsonSerializerOptions, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(httpClient, nameof(httpClient));
        ArgumentException.ThrowIfNullOrWhiteSpace(url, nameof(url));
        // 使用 ResponseHeadersRead 避免将全部响应体缓冲到内存
    ...
    /// <summary>
    /// 发送PATCH请求，使用自定义请求头和序列化选项将JSON数据序列化后发送，并将响应内容读取为流。
    /// </summary>
    /// <remarks>
    /// Sends a PATCH request with JSON serialized data, custom headers and serialization options, then reads the response content as a stream.
    /// Note: The caller is responsible for disposing the returned stream.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    ...
    /// <exception cref="ArgumentException">当 <paramref name="url"/> 为空字符串或空白字符串时抛出 / Thrown when <paramref name="url"/> is empty or whitespace</exception>
    /// <exception cref="HttpRequestException">当HTTP响应状态码表示失败时抛出 / Thrown when the HTTP response status code indicates failure</exception>
    public static async Task<Stream> PatchJsonToStreamAsync<TValue>(this HttpClient httpClient, string url, TValue data, IDictionary<string, string> headers, JsonSerializerOptions jsonSerializerOptions, int timeout = 10, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(httpClient, nameof(httpClient));
        ArgumentException.ThrowIfNullOrWhiteSpace(url, nameof(url));
