...
/// </summary>
/// <remarks>
/// Provides extension methods for HttpClient PUT requests.
/// </remarks>
public static class HttpClientPutExtension
{
    ...
    /// </summary>
    /// <remarks>
    /// Sends a PUT request with JSON serialized data and reads the response content as a string.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Sends a PUT request with JSON serialized data and custom headers, then reads the response content as a string.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// </summary>
    /// <remarks>
    /// Sends a PUT request with JSON serialized data and reads the response content as a byte array.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// </summary>
    /// <remarks>
    /// Sends a PUT request with JSON serialized data and custom headers, then reads the response content as a byte array.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    /// <param name="url">请求URL / The request URL</param>
    ...
    /// </summary>
    /// <remarks>
    /// Sends a PUT request with JSON serialized data and reads the response content as a stream.
    ...
    /// </summary>
    /// <remarks>
    /// Sends a PUT request with JSON serialized data and custom headers, then reads the response content as a stream.
    /// Note: The caller is responsible for disposing the returned stream.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="httpClient">HttpClient实例 / The HttpClient instance</param>
    ...
    /// </summary>
    /// <remarks>
    /// Creates a PUT request message with JSON content and custom headers.
    /// </remarks>
    /// <typeparam name="TValue">要发送的数据类型 / The type of data to send</typeparam>
    /// <param name="url">请求URL / The request URL</param>
    /// <param name="data">要发送的数据 / The data to send</param>
    ...
    private static HttpRequestMessage CreatePutRequest<TValue>(string url, TValue data, JsonSerializerOptions jsonSerializerOptions)
    {
        return CreatePutRequest(url, data, (IDictionary<string, string>?)null, jsonSerializerOptions);
    }
}