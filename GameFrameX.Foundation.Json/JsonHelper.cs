...
public static class JsonHelper
{
    ...
    /// 包含以下特性:
    /// <list type="bullet">
    /// <item><description>忽略null值属性</description></item>
    /// <item><description>忽略循环引用</description></item>
    /// <item><description>属性名称大小写不敏感</description></item>
    /// <item><description>枚举值序列化为字符串</description></item>
    /// </list>
    /// </summary>
    ...
    /// <item><description>属性名称大小写不敏感</description></item>
    /// <item><description>枚举值序列化为字符串</description></item>
    /// <item><description>输出格式化的JSON文本(包含缩进和换行)</description></item>
    /// </list>
    /// </summary>
